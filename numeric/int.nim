...
var
  ...
  a14 = vec3(1'i32, 2'i32, 3'i32)
  a15 = vec3(1'i64, 2'i64, 3'i64)

#  a21 = vec3[int](1, 2, 3)
#  a22 = vec3[int](1'i8, 2'i8, 3'i8)
#  a23 = vec3[int](1'i16, 2'i16, 3'i16)
#  a24 = vec3[int](1'i32, 2'i32, 3'i32)
#  a25 = vec3[int](1'i64, 2'i64, 3'i64)

  a31 = vec3[int8](1, 2, 3)
  a32 = vec3[int8](1'i8, 2'i8, 3'i8)
#  a33 = vec3[int8](1'i16, 2'i16, 3'i16)
#  a34 = vec3[int8](1'i32, 2'i32, 3'i32)
#  a35 = vec3[int8](1'i64, 2'i64, 3'i64)

  a41 = vec3[int16](1, 2, 3)
  a42 = vec3[int16](1'i8, 2'i8, 3'i8)
  a43 = vec3[int16](1'i16, 2'i16, 3'i16)
#  a44 = vec3[int16](1'i32, 2'i32, 3'i32)
#  a45 = vec3[int16](1'i64, 2'i64, 3'i64)

  a51 = vec3[int32](1, 2, 3)
  a52 = vec3[int32](1'i8, 2'i8, 3'i8)
  a53 = vec3[int32](1'i16, 2'i16, 3'i16)
  a54 = vec3[int32](1'i32, 2'i32, 3'i32)
#  a55 = vec3[int32](1'i64, 2'i64, 3'i64)
...
#  b11: Vec3[int8] = vec3(1, 2, 3)
  b12: Vec3[int8] = vec3(1'i8, 2'i8, 3'i8)
#  b13: Vec3[int8] = vec3(1'i16, 2'i16, 3'i16)
#  b14: Vec3[int8] = vec3(1'i32, 2'i32, 3'i32)
#  b15: Vec3[int8] = vec3(1'i64, 2'i64, 3'i64)

#  b21: Vec3[int8] = vec3[int](1, 2, 3)
#  b22: Vec3[int8] = vec3[int](1'i8, 2'i8, 3'i8)
#  b23: Vec3[int8] = vec3[int](1'i16, 2'i16, 3'i16)
#  b24: Vec3[int8] = vec3[int](1'i32, 2'i32, 3'i32)
#  b25: Vec3[int8] = vec3[int](1'i64, 2'i64, 3'i64)

  b31: Vec3[int8] = vec3[int8](1, 2, 3)
  b32: Vec3[int8] = vec3[int8](1'i8, 2'i8, 3'i8)
#  b33: Vec3[int8] = vec3[int8](1'i16, 2'i16, 3'i16)
#  b34: Vec3[int8] = vec3[int8](1'i32, 2'i32, 3'i32)
#  b35: Vec3[int8] = vec3[int8](1'i64, 2'i64, 3'i64)

#  b41: Vec3[int8] = vec3[int16](1, 2, 3)
#  b42: Vec3[int8] = vec3[int16](1'i8, 2'i8, 3'i8)
#  b43: Vec3[int8] = vec3[int16](1'i16, 2'i16, 3'i16)
#  b44: Vec3[int8] = vec3[int16](1'i32, 2'i32, 3'i32)
#  b45: Vec3[int8] = vec3[int16](1'i64, 2'i64, 3'i64)

#  b51: Vec3[int8] = vec3[int32](1, 2, 3)
#  b52: Vec3[int8] = vec3[int32](1'i8, 2'i8, 3'i8)
#  b53: Vec3[int8] = vec3[int32](1'i16, 2'i16, 3'i16)
#  b54: Vec3[int8] = vec3[int32](1'i32, 2'i32, 3'i32)
#  b55: Vec3[int8] = vec3[int32](1'i64, 2'i64, 3'i64)

#  b61: Vec3[int8] = vec3[int64](1, 2, 3)
#  b62: Vec3[int8] = vec3[int64](1'i8, 2'i8, 3'i8)
#  b63: Vec3[int8] = vec3[int64](1'i16, 2'i16, 3'i16)
#  b64: Vec3[int8] = vec3[int64](1'i32, 2'i32, 3'i32)
#  b65: Vec3[int8] = vec3[int32](1'i64, 2'i64, 3'i64)
...
#  c21: Vec3[int16] = vec3[int](1, 2, 3)
#  c22: Vec3[int16] = vec3[int](1'i8, 2'i8, 3'i8)
#  c23: Vec3[int16] = vec3[int](1'i16, 2'i16, 3'i16)
...
#  c35: Vec3[int16] = vec3[int8](1'i64, 2'i64, 3'i64)
  ...
  c41: Vec3[int16] = vec3[int16](1, 2, 3)
  c42: Vec3[int16] = vec3[int16](1'i8, 2'i8, 3'i8)
  c43: Vec3[int16] = vec3[int16](1'i16, 2'i16, 3'i16)
#  c44: Vec3[int16] = vec3[int16](1'i32, 2'i32, 3'i32)
#  c45: Vec3[int16] = vec3[int16](1'i64, 2'i64, 3'i64)

#  c51: Vec3[int16] = vec3[int32](1, 2, 3)
#  c52: Vec3[int16] = vec3[int32](1'i8, 2'i8, 3'i8)
#  c53: Vec3[int16] = vec3[int32](1'i16, 2'i16, 3'i16)
#  c54: Vec3[int16] = vec3[int32](1'i32, 2'i32, 3'i32)
#  c55: Vec3[int16] = vec3[int32](1'i64, 2'i64, 3'i64)

#  c61: Vec3[int16] = vec3[int64](1, 2, 3)
#  c62: Vec3[int16] = vec3[int64](1'i8, 2'i8, 3'i8)
#  c63: Vec3[int16] = vec3[int64](1'i16, 2'i16, 3'i16)
#  c64: Vec3[int16] = vec3[int64](1'i32, 2'i32, 3'i32)
#  c65: Vec3[int16] = vec3[int32](1'i64, 2'i64, 3'i64)
...
#  d22: Vec3[int32] = vec3[int](1'i8, 2'i8, 3'i8)
#  d23: Vec3[int32] = vec3[int](1'i16, 2'i16, 3'i16)
...
#  d45: Vec3[int32] = vec3[int16](1'i64, 2'i64, 3'i64)
  ...
  d51: Vec3[int32] = vec3[int32](1, 2, 3)
  d52: Vec3[int32] = vec3[int32](1'i8, 2'i8, 3'i8)
  d53: Vec3[int32] = vec3[int32](1'i16, 2'i16, 3'i16)
  d54: Vec3[int32] = vec3[int32](1'i32, 2'i32, 3'i32)
#  d55: Vec3[int32] = vec3[int32](1'i64, 2'i64, 3'i64)

#  d61: Vec3[int32] = vec3[int64](1, 2, 3)
#  d62: Vec3[int32] = vec3[int64](1'i8, 2'i8, 3'i8)
#  d63: Vec3[int32] = vec3[int64](1'i16, 2'i16, 3'i16)
#  d64: Vec3[int32] = vec3[int64](1'i32, 2'i32, 3'i32)
#  d65: Vec3[int32] = vec3[int32](1'i64, 2'i64, 3'i64)
...
#  e22: Vec3[int64] = vec3[int](1'i8, 2'i8, 3'i8)
#  e23: Vec3[int64] = vec3[int](1'i16, 2'i16, 3'i16)
...
#  e55: Vec3[int64] = vec3[int32](1'i64, 2'i64, 3'i64)
  ...
  e62: Vec3[int64] = vec3[int64](1'i8, 2'i8, 3'i8)
  e63: Vec3[int64] = vec3[int64](1'i16, 2'i16, 3'i16)
  e64: Vec3[int64] = vec3[int64](1'i32, 2'i32, 3'i32)
#  e65: Vec3[int64] = vec3[int32](1'i64, 2'i64, 3'i64)
